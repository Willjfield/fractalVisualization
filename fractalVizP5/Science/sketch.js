...
function setup(){
	...
	var url = "https://www.reddit.com/r/science/comments/4h90t5/happiness_genes_located_for_the_first_time_a_huge/.json"

	$.getJSON( url, function( data ) {
	  	var numComments = data[0].data.children[0].data.num_comments
		//var mag = convert(numComments).toString()
		var complexity = map(numComments,0,10000,0,6);
